namespace GameCreator.Shooter
{
    ...
    public class CharacterAimIK : MonoBehaviour
    {
        ...
        private const float DEFAULT_SMOOTH = 0.5f;
        ...
        private static readonly Weapon.Bending[] AIMING =
        {
            ...
            new Weapon.Bending() { bone = HumanBodyBones.Chest, weight = 0.2f },
            new Weapon.Bending() { bone = HumanBodyBones.UpperChest, weight = 0.2f },
            new Weapon.Bending() { bone = HumanBodyBones.LeftShoulder, weight = 0.4f },
            new Weapon.Bending() { bone = HumanBodyBones.RightShoulder, weight = 0.4f }
        };
        */
        private static readonly Weapon.Bending[] AIMING =
        {
