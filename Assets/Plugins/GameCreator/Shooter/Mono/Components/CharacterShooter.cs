namespace GameCreator.Shooter
{
    ...
    public class CharacterShooter : GlobalID, IGameSave
    {
        ...
        public CharacterAimIK aimIK { get; private set; }

        protected CharacterAmmoData ammoData = new CharacterAmmoData();

        public GameObject modelWeapon { get; private set; }
        public WeaponMuzzle muzzle { get; private set; }
        ...
        public bool isHolstering { get; private set; }

        public AimingBase aiming { get; private set; }
        ...
        private IEnumerator EquipWeapon(Weapon weapon, Ammo ammo)
        {
            if (weapon != null)
            {
                ...
                this.modelWeapon = this.currentWeapon.EquipWeapon(this.animator);
        ...
        private float ChangeState(Weapon.State state, CharacterAnimation.Layer layer)
        {
        ...
        protected virtual void OnEquipWeapon() { }
        protected virtual void OnUnequipWeapon() { }
        ...
        public void OnLoad(object generic)
        {
            ...
            if (this.ammoData == null) this.ammoData = new CharacterAmmoData();
